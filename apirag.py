...
class ResponseGenerator:
    ...
    async def generate_response(self, query):
        # Determine the destination based on the user's query.
...
# ---------------------------
# Granite Assistant with RAG and File-Based Document Loading
# ---------------------------
    ...
    def __init__(self, path: str):
        ...
        if os.path.isfile(path):
            if path.lower().endswith('.pdf'):
                # Load and split the PDF page by page.
        ...
        embeddings = OpenAIEmbeddings(openai_api_key="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")
        # print(docs)
        vectorstore = FAISS.from_documents(docs, embeddings)
        # Set up conversation memory.
        self.memory = ConversationBufferMemory(memory_key="chat_history", return_messages=True)
        # Use the custom GraniteLLM.
        llm = GraniteLLM()
